...
class ViewController: UIViewController {
    ...
    private func showFirstLaunchAlert() {
        ...
        let alert = UIAlertController(title: String(localized: "welcome_to_sku_manager", comment: "Title for the welcome alert"),
                                      message: String(localized: "camera_view_scan_instructions", comment: "Instructions for using camera view to scan barcode or manual entry"),
                                      preferredStyle: .alert)
        alert.addAction(UIAlertAction(title: String(localized: "got_it", comment: "Confirmation button on the welcome alert"), style: .default, handler: { _ in
