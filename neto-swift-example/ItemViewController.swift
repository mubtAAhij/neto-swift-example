        ...
        let task = URLSession.shared.dataTask(with: request) { data, response, error in
            ...
            if let responseJSON = responseJSON as? [String: Any] {
                ...
                if (itemData.count > 0) {
                    ...
                    DispatchQueue.main.async {
                        self.navigationItem.title = String(localized: "item_not_found", comment: "Title shown when an item cannot be found")
                    }
                }
            }
        }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (self.itemData != nil) {
            if (indexPath.row == 0) {
                ...
                cell.textLabel?.text = String(localized: "inventory_id", comment: "Label for inventory ID field in item details")
                ...
                cell.textLabel?.text = String(localized: "is_active", comment: "Label for item active status in details view")
                ...
                cell.textLabel?.text = String(localized: "product_url", comment: "Label for product URL in item details")
                ...
                if let wq = self.itemData["WarehouseQuantity"] as? [Any] {
                    if wq.count != 0 && indexPath.row - 12 < wq.count {
                        if let wqi = wq[indexPath.row - 12] as? [String: Any] {
                            cell.textLabel?.text = String(String(localized: "warehouse_quantity_label", comment: "Label showing warehouse ID and quantity"))
